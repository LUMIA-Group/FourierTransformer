    ...
    def __init__(self, cfg: FairseqConfig, task, model, criterion, quantizer=None):
        ...
        if self.is_fsdp:
            ...
            if (
                ...
                raise ValueError(
                    "--cpu-offload requires --ddp-backend=fully_sharded")
    ...
    def _build_optimizer(self):
        ...
        if self.is_fsdp and self.cfg.common.fp16:
            ...
            if (
                ...
                self._optimizer = optim.AMPOptimizer.build_optimizer(
                    self.cfg, params)
            else:
        ...
        state_dict = {
            ...
            "cfg": (
                OmegaConf.to_container(
                    self.cfg, resolve=True, enum_to_str=True)
        ...
        results = list(
            zip(
                *distributed_utils.all_gather_list(
                    ...
                    max_size=getattr(
                        self.cfg.common, "all_gather_list_size", 16384),
                    group=self.data_parallel_process_group,
                )
            )
        )
